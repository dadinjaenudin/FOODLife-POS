...
class Bill(models.Model):
    ...
    def generate_bill_number(self):
        ...
        prefix = f"{self.outlet_id:03d}-{today}"
    ...
    def calculate_totals(self):
        ...
        self.tax_amount = after_discount * (self.outlet.tax_rate / 100)
        self.service_charge = after_discount * (self.outlet.service_charge / 100)

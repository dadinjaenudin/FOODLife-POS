# Generated by Django 5.2.10 on 2026-01-31 14:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['brand', 'is_active'], name='tables_tabl_brand_active_idx'),
        ),
        migrations.AddIndex(
            model_name='tablearea',
            index=models.Index(fields=['company', 'is_active'], name='tables_tabl_company_active_idx'),
        ),
        migrations.AddIndex(
            model_name='tablearea',
            index=models.Index(fields=['store', 'is_active'], name='tables_tabl_store_active_idx'),
        ),
        migrations.AddIndex(
            model_name='tablegroup',
            index=models.Index(fields=['brand', 'created_at'], name='tables_tabl_brand_created_idx'),
        ),
        migrations.AddIndex(
            model_name='tablegroup',
            index=models.Index(fields=['main_table'], name='tables_tabl_main_table_idx'),
        ),
        migrations.AddIndex(
            model_name='table',
            index=models.Index(fields=['area', 'is_active'], name='tables_tabl_area_active_idx'),
        ),
        migrations.AddIndex(
            model_name='table',
            index=models.Index(fields=['number'], name='tables_tabl_number_idx'),
        ),
    ]
